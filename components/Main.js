    ...
    <section class='text-gray-600 body-font'>
      <div class='max-w-5xl pt-52 pb-24 mx-auto'>
        <h1 class='text-80 text-center font-4 lh-6 ld-04 font-bold text-white mb-6'>
          Realize seu sonho de ter um iPhone
        </h1>
        <h2 class='text-2xl font-4 font-semibold lh-6 ld-04 pb-11 text-gray-700 text-center'>
          Apple Fast é o melhor lugar para comprar seus produtos Apple
          <br />
          com o melhor preço e a melhor qualidade.
        </h2>
        <div className='ml-6 text-center'>
          ...
          >
            <div className='flex text-lg'>
              <span className='justify-center'>Conheça Nosso Trabalho</span>
            </div>
          </a>
          <a
          ...
          >
            <div className='flex text-lg'>
              <span className='justify-center'>Compre Conosco</span>
            </div>
          </a>
        </div>
      </div>
      ...
      <h2 className='pt-40 mb-1 text-2xl font-semibold tracking-tighter text-center text-gray-200 lg:text-7xl md:text-6xl'>
        Conheça Nossa Trabalho
      </h2>
      <br></br>
      <p className='mx-auto text-xl text-center text-gray-300 font-normal leading-relaxed fs521 lg:w-2/3'>
        Aqui está uma pequena amostra do que podemos fazer para você.
      </p>
      <div className='pt-12 pb-24 max-w-4xl mx-auto fsac4 md:px-1 px-3'>
        <div class='ktq4'>
          ...
          ></img>
          <h3 class='pt-3 font-semibold text-lg text-white'>Consultoria</h3>
          <p class='pt-2 value-text text-md text-gray-200 fkrr1'>
            Esclarecer suas dúvidas, entender suas necessidades e oferecer a
        ...
        <div class='ktq4'>
          <img
            ...
            src='./images/applefastlogo.png'
          ></img>
          <h3 class='pt-3 font-semibold text-lg text-white'>Pagamento</h3>
          <p class='pt-2 value-text text-md text-gray-200 fkrr1'>
            Nós oferecemos uma variedade de opções de pagamento para você
            escolher e estamos sempre abertos à negociações.
          </p>
        </div>
        <div class='ktq4'>
          <img
          ...
          <p class='pt-2 value-text text-md text-gray-200 fkrr1'>
            Nós entregamos e instalamos seus produtos Apple em qualquer lugar do
            Brasil.
          </p>
        </div>
        <div class='ktq4'>
          ...
          <p class='pt-2 value-text text-md text-gray-200 fkrr1'>
            Nós oferecemos suporte e garantia para todos os nossos produtos.
            Todos os nossos produtos são lacrados e originais, possuindo
        ...
        <div class='max-w-6xl mx-auto px-4 sm:px-6 text-center'>
          <div class='py-24 md:py-36'>
            ...
            <h1 class='mb-9 text-2xl font-semibold text-gray-200'>
              Coloque seu email para receber nossas novidades
            </h1>
            <input
              type='email'
